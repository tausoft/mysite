...
urlpatterns = [
    ...
    url(r'^bazaznanja_cst/$', views.bazaznanja_cst, name ='bazaznanja_cst'),
    url(r'^bazaznanja_cst/troubleshooter/$', views.troubleshooter, name ='troubleshooter'),
    url(r'^bazaznanja_cst/article_admin/$', views.article_admin, name ='article_admin'),
]